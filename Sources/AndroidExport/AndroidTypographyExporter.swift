...
final public class AndroidTypographyExporter {
    ...
    private let includeFontPadding: Bool?
    ...
    public init(
        ...
        self.includeFontPadding = includeFontPadding
    }
    ...
    private func prepareTypographyDotXMLContents(
        ...
        textStyles.forEach { textStyle in
            ...
            if let includeFontPadding = self.includeFontPadding {
                let itemIncludeFontPadding = XMLElement(name: "item", stringValue: "\(includeFontPadding)")
                itemIncludeFontPadding.addAttribute(XMLNode.attribute(withName: "name", stringValue: "android:includeFontPadding") as! XMLNode)
                style.addChild(itemIncludeFontPadding)
            }
